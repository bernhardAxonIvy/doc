...
with additional information about where and how to store the data of a class
and its attributes in a relational database. An Entity Class is mapped
...
of those are similar to the wizard and editor for regular Data Classes, but
allow specifying additional settings, that are necessary for automated
persistence.
