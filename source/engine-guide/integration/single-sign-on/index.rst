...
|ivy-engine| supports Single Sign-on. However, the configuration depends on
the given infrastructure. But the concept looks always the same. The user is
browsing the |ivy-engine| over and intermediate service - a :ref:`reverse
...
.. warning::
    If you enable SSO you must ensure that the |ivy-engine| cannot be
